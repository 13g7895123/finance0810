  ...
  <div class="space-y-6">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            ...
            >
            <label for="auto-refresh" class="text-sm text-gray-600 dark:text-gray-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="flex items-center">
          <div class="flex-1">
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">總執行次數</p>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ statistics?.total_executions || 0 }}</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="flex items-center">
          <div class="flex-1">
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">成功執行</p>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="flex items-center">
          <div class="flex-1">
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">失敗執行</p>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div class="flex items-center">
          <div class="flex-1">
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">平均耗時</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">狀態篩選</label>
          <select 
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">類型篩選</label>
          <select 
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">時間範圍</label>
          <select 
        ...
        <div>
          ...
          <input 
            ...
            class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          >
        </div>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
      ...
      <!-- 分頁 -->
      <div v-if="pagination && pagination.total > pagination.per_page" class="bg-white dark:bg-gray-800 px-4 py-3 border-t border-gray-200 dark:border-gray-700 sm:px-6">
        ...
        >
          <div class="sm:flex sm:items-start">
            <div class="w-full">
              ...
              <!-- 基本信息 -->
              <div class="mb-6">
                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">基本信息</h4>
              ...
              <div v-if="selectedLog.error_message" class="mb-6">
                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">錯誤信息</h4>
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <p class="text-red-800 dark:text-red-200">{{ selectedLog.error_message }}</p>
                  <div v-if="selectedLog.error_details" class="mt-2">
                    <pre class="text-xs text-red-700 dark:text-red-300 overflow-x-auto">{{ JSON.stringify(selectedLog.error_details, null, 2) }}</pre>
                  </div>
                </div>
              </div>
              ...
              <div v-if="selectedLog.execution_steps && selectedLog.execution_steps.length > 0" class="mb-6">
                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">執行步驟</h4>
                <div class="space-y-2 max-h-96 overflow-y-auto">
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-center justify-between">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ step.step }}</p>
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ formatDateTime(step.timestamp) }}</span>
                      </div>
                      <div v-if="step.details" class="mt-1">
                        <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto max-h-32">{{ JSON.stringify(step.details, null, 2) }}</pre>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="selectedLog.events_data && selectedLog.events_data.length > 0" class="mb-6">
                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">事件數據</h4>
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto max-h-64">{{ JSON.stringify(selectedLog.events_data, null, 2) }}</pre>
                </div>
              </div>

              <!-- 結果數據 -->
              <div v-if="selectedLog.results" class="mb-6">
                <h4 class="text-md font-medium text-gray-900 dark:text-white mb-3">執行結果</h4>
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <pre class="text-xs text-gray-600 dark:text-gray-400 overflow-x-auto">{{ JSON.stringify(selectedLog.results, null, 2) }}</pre>
                </div>
              </div>
            </div>
          </div>
